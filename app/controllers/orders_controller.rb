class OrdersController < ApplicationController
  ...
  respond_to :json, :html #respond_to :json will allow access through the JSON API (:html makes sure we are still able to access our orders controller through html pages.
